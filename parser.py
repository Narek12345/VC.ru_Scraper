...
for link in article_links:
	...
	create_db.cur.execute("INSERT INTO articles VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?);", (article_name, article_url, subject_article, article_views, article_publish_time, author_name, author_link, article_likes, article_comment, favorites))
